...
#define RF24L01_CE_GPIO_PIN			GPIO_PIN_3

#define RF24L01_IRQ_GPIO_PORT			GPIOD
#define RF24L01_IRQ_GPIO_PIN			GPIO_PIN_2

#define RF24L01_CS_GPIO_PORT			SPI_NSS_GPIO_PORT			//PA3
#define RF24L01_CS_GPIO_PIN				SPI_NSS_GPIO_PIN

/** 口线操作函数定义 */
#define RF24L01_SET_CE_HIGH( )			GPIO_WriteHigh( RF24L01_CE_GPIO_PORT, RF24L01_CE_GPIO_PIN )
#define RF24L01_SET_CE_LOW( )			GPIO_WriteLow( RF24L01_CE_GPIO_PORT, RF24L01_CE_GPIO_PIN )

#define RF24L01_SET_CS_HIGH( )			spi_set_nss_high( )
#define RF24L01_SET_CS_LOW( )			spi_set_nss_low( )

#define RF24L01_GET_IRQ_STATUS( )		( 0x00 == ( RF24L01_IRQ_GPIO_PORT->IDR & RF24L01_IRQ_GPIO_PIN )) ? 0 : 1	//IRQ状态
