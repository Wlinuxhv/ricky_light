...
{
    EEP_Wait_Finished();
    eeprom_variable[0] = 'O';   //"TG80" is written  in the EEPROM
    EEP_Wait_Finished();
    eeprom_variable[1] = 'L';   //This allows to check later that the EEPROM content is valid.
    EEP_Wait_Finished();
    eeprom_variable[2] = 'E';
    EEP_Wait_Finished();
    eeprom_variable[3] = 'D';
